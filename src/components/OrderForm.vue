          ...
          <div class="col-xl-10">
            ...
            <div class="card modern-card mb-3 bg-white border-0 shadow-sm">
                <div class="card-body d-flex justify-content-between align-items-center p-4">
                    <div>
                        <h2 class="fw-bold text-primary mb-1">Vibras</h2> <p class="text-muted mb-0 small">Calle Cualquiera 123, Cualquier Lugar</p>
                        <p class="text-muted mb-0 small">Tel: (55) 1234-5678 | Email: hola@sitioincreible.com</p>
                    </div>
                    <div class="text-end">
                        <img src="https://via.placeholder.com/120x60/667eea/ffffff?text=Vibras+Logo" alt="Logo Compañía" class="img-fluid rounded" style="max-height: 60px;">
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                      ...
                      <tr v-for="(item, index) in detalleFactura" :key="index">
                        ...
                        <td class="text-center pe-4">
                          <button class="btn btn-sm btn-outline-danger border-0 rounded-circle p-2" @click="eliminarProducto(index)" title="Quitar">
              ...
              <div class="card-footer bg-light p-4 border-top">
                <div class="row justify-content-end">
                  <div class="col-md-4">
                    ...
                    <button 
                        class="btn btn-primary w-100 py-3 fw-bold shadow-sm modern-btn" 
...
export default {
  ...
  computed: {
    subtotal() { return this.detalleFactura.reduce((sum, item) => sum + (item.cantidad * item.precioUnitario), 0); },
    totalPagar() { return this.subtotal; },
    fechaActual() { return this.fechaFactura || new Date().toLocaleDateString('es-ES'); }
  },
  mounted() {
  ...
  methods: {
    ...
    agregarDirecto(p) {
        ...
        this.detalleFactura.push({
            ...
            cantidad: 1, stockMax: p.unitsInStock // Guardamos stock total original para validaciones en tabla
        });
    ...
    // NUEVO: Validación al escribir manualmente
    ...
    eliminarProducto(index) { this.detalleFactura.splice(index, 1); },

    // --- GUARDAR (MODIFICADO PARA REDIRIGIR) ---
    async guardarFactura() {
        ...
        try {
            ...
            // REDIRECCIÓN A LA PÁGINA DE IMPRESIÓN
