        ...
        <div class="stats-section">
          <div class="stat-card">
            ...
            <div class="stat-content">
              ...
              <div class="stat-value">Panel de control</div>
            </div>
          </div>
          ...
          <div class="stat-card">
            <router-link to="/perfil" class="stat-link">
              <div class="stat-icon bg-info-soft">
                <i class="bi bi-person-circle text-info"></i>
              </div>
              <div class="stat-content">
                <div class="stat-label">Mi cuenta</div>
                <div class="stat-value">Ver perfil</div>
              </div>
            </router-link>
          </div>
        </div>
...
/* Cards Grid - ACTUALIZADO 
   Usamos auto-fit para que se acomoden 4 tarjetas perfectamente 
*/
.cards-grid {
  display: grid;
  /* Esto asegura que las tarjetas se ajusten. Si hay espacio, caben 4. Si no, bajan. */
